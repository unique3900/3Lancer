...
const Hero = () => {
  return (
    <section id='hero' className='relative z-10 min-h-screen bg-indigo-600 w-full flex flex-col justify-center gap-8 '>
          <div className="flex flex-col gap-4 h-[80%] items-center justify-center mb-40">
              <h1 className="text-6xl lg:text-9xl text-white font-[1000]">3Lancer</h1>
              <p className="text-lg font-bold text-white">One Stop Solution For Job Posting and Finding</p>

              {/* Search Form */}
              <div className="w-[80%] lg:w-8/12 flex justify-center items-center bg-white shadow-md shadow-black/60 rounded-md p-5">
                  <form className='flex flex-col   items-center lg:flex-row justify-center lg:items-end gap-4'>
                      ...
                      <div className="flex flex-col justify-center gap-2">
                          ...
                          <input type="text" name='job-keyword' className='rounded-md w-96 lg:w-fit border-2 border-black border-opacity-50 px-3 py-2 ' />
                      </div>
                      <div className="flex flex-col justify-center gap-2">
                          ...
                          <input type="text" name='job-location' className='rounded-md w-96 lg:w-fit border-2 border-black border-opacity-50 px-3 py-2 ' />
                      </div>
